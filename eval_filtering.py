...
def evaluate_filtering():
    ...
    parser.add_argument(
        "--ckpt_path", type=str, default="./comp_g", help="path of the checkpoints"
    )
    parser.add_argument(
        "--evol_path",
        type=str,
    ...
    success_9 = []  # Success @ 0.9m
    success_8 = []  # Success @ 0.8m
    success_7 = []  # Success @ 0.7m
    success_6 = []  # Success @ 0.6m
    success_5 = []  # Success @ 0.5m
    success_4 = []  # Success @ 0.4m
    success_3 = []  # Success @ 0.3m
    success_2 = []  # Success @ 0.2m
    success_1 = []  # Success @ 0.1m
    ...
    for data_idx in tqdm.tqdm(range(len(test_set))):
        ...
        if log_error:
            ...
            if all(last_errors < 0.9):
                success_9.append(True)
            else:
                success_9.append(False)

            if all(last_errors < 0.8):
                success_8.append(True)
            else:
                success_8.append(False)

            if all(last_errors < 0.7):
                success_7.append(True)
            else:
                success_7.append(False)

            if all(last_errors < 0.6):
                success_6.append(True)
            else:
                success_6.append(False)
            ...
            if all(last_errors < 0.4):
                success_4.append(True)
            else:
                success_4.append(False)
            ...
            if all(last_errors < 0.1):
                success_1.append(True)
            else:
                success_1.append(False)

    if log_error:
        RMSEs = np.array(RMSEs)
        success_10 = np.array(success_10)
        success_9 = np.array(success_9)
        success_8 = np.array(success_8)
        success_7 = np.array(success_7)
        success_6 = np.array(success_6)
        success_5 = np.array(success_5)
        success_4 = np.array(success_4)
        ...
        print("0.9 success rate : ", success_9.sum() / len(test_set))
        print("0.8 success rate : ", success_8.sum() / len(test_set))
        print("0.7 success rate : ", success_7.sum() / len(test_set))
        print("0.6 success rate : ", success_6.sum() / len(test_set))
        print("0.5 success rate : ", success_5.sum() / len(test_set))
        print("0.4 success rate : ", success_4.sum() / len(test_set))
        print("0.3 success rate : ", success_3.sum() / len(test_set))
        print("0.2 success rate : ", success_2.sum() / len(test_set))
        print("0.1 success rate : ", success_1.sum() / len(test_set))
