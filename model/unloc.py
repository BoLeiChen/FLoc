...
from model.mono.modules.network_utils import *
import math

class Unloc(nn.Module):
...
class UnlocFeatureExtractor(nn.Module):
    def __init__(self, encoder="vits", fH=30, fW=40, embed_dim=128, pos_embed_dim=32, num_heads=8, target_size=(30, 40), checkpoint_path=None):
        super().__init__()
    ...
    def forward(self, obs_img, mask=None):
        ...
        features_tensor = features[0] # (B, 37 x 49, 384)
